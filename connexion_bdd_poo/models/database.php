...
abstract class database
{
     ...
     * @return string
     */
    protected function SendData(string $request, array $data = NULL)
    {
        try {
            $bdd = $this->ConnectDB();
     ...
     * @return string |array
     */
    protected function GetOneData($request, $data = NULL)
    {
        try {
            $bdd = $this->ConnectDB();
            $requette = $bdd->prepare($request);
     ...
     * @return string | array
     */
    protected function GetManyData($request, $data = NULL)
    {
        try {
            $bdd = $this->ConnectDB();
            $requette = $bdd->prepare($request);
